...
import org.jivesoftware.openfire.plugin.chatsquare.FileManager;
import org.jivesoftware.openfire.plugin.chatsquare.PushNotificationManager;
 ...
 */
public class ChatSquarePlugin implements Plugin, Component {

	private static final Logger Log = LoggerFactory.getLogger(ChatSquarePlugin.class);
	
    private static final String subdomain = "chatsquare";
    ...
    public void initializePlugin(PluginManager manager, File pluginDirectory) {
    	...
    	FileManager.sharedManager().setDefaultDirectory(pluginDirectory);
